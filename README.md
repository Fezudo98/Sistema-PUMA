...
- **Trilha de Desbloqueios (Streaks):** Sistema dinâmico de recompensas baseado em sequência de dias (Ofensiva). Ao atingir **25 Dias**, o aluno desbloqueia o Tema RAIO ⚡; ao atingir **35 Dias**, desbloqueia o Tema BEPI 🦅 (identidade visual do Batalhão Especializado de Policiamento do Interior). A barra de progresso evolui automaticamente de cor e aponta a próxima meta.
