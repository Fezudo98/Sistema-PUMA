  ...
  return (
    <>
      <div 
        ...
        className={`w-10 h-10 rounded-full bg-muted text-heading flex items-center justify-center font-bold overflow-hidden border-2 border-transparent transition-all shadow-sm ${disableModal ? '' : 'cursor-pointer hover:border-blue-500'}`}
