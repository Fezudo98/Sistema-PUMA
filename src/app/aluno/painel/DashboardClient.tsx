...
const getBadges = (stats: any) => {
  ...
  return [
    ...
    },
    {
      ...
      desc: 'Completou 5 simulados. Mostrou persistência.',
    ...
    },
    {
      ...
      desc: 'Completou 10 simulados. Um verdadeiro veterano.',
    ...
    },
    {
      ...
      icon: Crosshair,
      earned: s.history && s.history.some((h: any) => h.accuracy === 100 && h.totalQuestions > 0),
      desc: 'Gabaritou 100% de acertos em um simulado.',
    ...
    },
    {
      ...
      icon: Zap,
      earned: s.simuladosCount >= 1 && s.avgTime <= 15 && s.avgTime > 0,
      desc: 'Manteve tempo médio de resposta abaixo de 15 segundos.',
    ...
    },
    {
      ...
      name: 'Caveira',
      icon: Skull,
      earned: s.simuladosCount >= 3 && s.accuracy >= 80,
      desc: 'Manteve taxa global de acertos acima de 80% (mínimo 3 simulados).',
    ...
    },
    {
      ...
      name: 'Padrão PM',
      icon: Medal,
      earned: s.totalScore >= 1000,
      desc: 'Alcançou a incrível marca de 1.000 pontos totais acumulados.',
      color: 'text-blue-500',
      bg: 'bg-blue-900/20',
