    ...
    >
      ...
      <div className="w-full max-w-md z-10">
        <div className="flex flex-col items-center mb-8">
          <Image src="/logo.png" alt="Sistema PUMA" width={100} height={100} className="drop-shadow-lg" />
          <h1 className="text-3xl font-extrabold text-white mt-4">Sistema <span className="text-blue-500">PUMA</span></h1>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="register">
                <form action={(f) => handleAction(f, false)} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Número do Combatente (1 a 33)</label>
                    <select 
                      name="numero" 
                      required 
                      defaultValue=""
