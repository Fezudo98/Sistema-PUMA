    ...
    <Card className="bg-card/40 border-border shadow-2xl relative overflow-hidden">
      ...
      <CardHeader className="border-b border-border bg-card/80 p-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <CardDescription className="text-muted-foreground font-medium">Radar de desempenho, credenciais e fiscalização de conversas no Mentor IA.</CardDescription>
        </div>
      ...
      <CardContent className="p-0">
        {filteredStudents.length === 0 ? (
          <div className="p-12 text-center text-muted-foreground font-bold uppercase tracking-wider">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-border bg-card/60 text-[11px] font-black uppercase tracking-widest text-muted-foreground">
                ...
                {filteredStudents.map((student, index) => {
                  ...
                  return (
                    ...
                    >
                            ...
                            {(() => {
                              ...
                              return (
                                <div className={`shrink-0 rounded-full ${p.avatarRing || ''}`}>
                                  {student.avatarUrl ? (
                                    <img src={student.avatarUrl} alt={student.name} className="w-8 h-8 rounded-full object-cover border border-border" />
                                  ) : (
                      ...
                      <td className="p-5 text-center text-muted-foreground font-bold">{student.totalAnswers}</td>
                      <td className="p-5 text-center">
                      ...
                      <td className="p-5 text-center text-muted-foreground font-mono font-bold">
            ...
            <DialogTitle className="text-lg font-black uppercase tracking-widest text-heading flex items-center justify-between">
              <div className="flex items-center gap-3">
                {selectedStudent?.avatarUrl ? (
                  ...
                  <div className="w-11 h-11 rounded-full bg-card border-2 border-blue-500 flex items-center justify-center text-blue-500">
                ...
                <div>
                  ...
                  <DialogDescription className="text-muted-foreground font-bold uppercase tracking-widest text-[10px] block mt-0.5">
            ...
            {activeModalTab === "dossier" ? (
              ...
              <div className="space-y-6">
                ...
                <div className="bg-card/30 border border-border rounded-xl p-4">
                  <h4 className="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-2 border-b border-border pb-2">Parecer Tático do Aluno</h4>
              ...
              <div className="space-y-6">
                ...
                {loadingSimulados ? (
                  <div className="py-12 flex flex-col items-center justify-center">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-wider text-muted-foreground mt-2">Carregando relatórios...</span>
                  </div>
                          ...
                          >
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div className="text-right">
                                ...
                                <div className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">Pontuação</div>
                              </div>
                                  ...
                                  <div key={q.id} className="space-y-3 pb-4 border-b border-border last:border-b-0 last:pb-0">
                                    <div className="flex justify-between items-start gap-3">
                                      ...
                                      <div className="flex items-center gap-1.5 shrink-0">
                                        <span className="text-[9px] font-mono text-muted-foreground font-bold uppercase">{q.tempoGasto}s</span>
                      ...
                      {auditMessages.map((msg) => (
                        <div 
                          ...
                          className={`p-3.5 rounded-xl border text-xs space-y-1.5 ${
                            msg.role === "user" 
                              ? "bg-blue-950/20 border-blue-900/30 text-foreground ml-6" 
                              : "bg-card/60 border-border text-muted-foreground mr-6"
                          }`}
                        >
                          <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-wider">
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="text-muted-foreground truncate max-w-[160px]" title={msg.apostilaTitle}>
                                📘 {msg.apostilaTitle}
                              </span>
                            </div>
