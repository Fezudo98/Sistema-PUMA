...
if not exist node_modules\.prisma\client if not exist node_modules\.prisma\client if not exist node_modules\.prisma\client if not exist node_modules\.prisma\client call npx prisma generate
